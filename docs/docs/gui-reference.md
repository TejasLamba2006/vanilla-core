...
This page provides a complete guide to using the in-game configuration GUI. The GUI allows you to manage all SMP Watchdog features without editing configuration files.
